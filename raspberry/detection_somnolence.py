...
EAR_DEFAUT        = 0.261    # Seuil par défaut (remplacé après calibration)
EAR_FRAMES_SEUIL  = 20      # Frames consécutives avant niveau 1
MAR_SEUIL         = 0.650    # Bâillement (validé UTA-RLDD)
PERCLOS_SEUIL     = 0.350    # >35% frames yeux fermés → somnolence (NTHU-DDD)
